...
"[project]/app/login/handlers/userHandlers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const criarUsuario = async (nome, email, senha, setStatus)=>{
    try {
        setStatus === null || setStatus === void 0 ? void 0 : setStatus("🔑 Gerando chaves...");
        const { publicKey: hpkePub, privateKey: hpkePriv } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateHpkeKeyPair"])();
        const dil = await __turbopack_context__.A("[project]/app/crypto/dilithium.ts [app-client] (ecmascript, async loader)");
        const { publicKey: dPub, privateKey: dPriv } = await dil.generateDilithiumKeyPair(2);
        // manda pro backend
        setStatus === null || setStatus === void 0 ? void 0 : setStatus("📤 Enviando dados...");
        const res = await fetch("/api/register", {
            ...
            body: JSON.stringify({
                ...
                email,
                senha,
                pk_kyber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(Uint8Array.from(hpkePub)),
                pk_dilithium: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(Uint8Array.from(dPub))
            })
        });
        ...
        const fileObj = {
            kyber: {
                public: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(hpkePub),
                private: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(hpkePriv)
            },
            dilithium: {
                public: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(dPub),
                private: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$crypto$2f$hpke$2d$kem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["b64uEncode"])(dPriv)
            }
        };
        const blob = new Blob([
        ...
        a.href = url;
        a.download = "".concat(email, "_keys.json");
        a.click();
        a.remove();
        URL.revokeObjectURL(url);
        setStatus === null || setStatus === void 0 ? void 0 : setStatus("Usuário criado! Arquivo de chaves baixado.");
    } catch (err) {
        console.error(err);
        setStatus === null || setStatus === void 0 ? void 0 : setStatus("Erro ao criar usuário");
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
"[project]/components/login/RegisterForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$login$2f$handlers$2f$userHandlers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/login/handlers/userHandlers.ts [app-client] (ecmascript)");
;
...
function RegisterForm() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$login$2f$handlers$2f$userHandlers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["criarUsuario"])(nome, email, senha, setStatus);
        setNome("");
        setEmail("");
        setSenha("");
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                fileName: "[project]/components/login/RegisterForm.tsx",
                lineNumber: 19,
                columnNumber: 7
            }, this),
...
_s(RegisterForm, "F+B65vI60UH9R5yxOVSGCc17x5g=");
_c = RegisterForm;
var _c;
...
"[project]/app/login/handlers/authHandlers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/login/LoginForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$login$2f$handlers$2f$authHandlers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/login/handlers/authHandlers.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function LoginForm() {
    ...
    const { refreshUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$providers$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [senha, setSenha] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [status, setStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const handleSubmit = async (e)=>{
        e.preventDefault();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$login$2f$handlers$2f$authHandlers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUsuario"])(email, senha, router, setStatus);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                fileName: "[project]/components/login/LoginForm.tsx",
                lineNumber: 26,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
...
_s(LoginForm, "JlYDyknNf/gHM/V0pIIQsyiPLOk=", false, function() {
    return [
...
//# sourceMappingURL=_b792a48d._.js.map