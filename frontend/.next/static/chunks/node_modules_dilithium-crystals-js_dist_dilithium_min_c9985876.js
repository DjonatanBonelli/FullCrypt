    ...
    944: (e, t, r)=>{
        var o, n = (o = (o = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0) || "/index.js", function(e) {
            ...
            if (l) {
                ...
                g = c ? r(507).dirname(g) + "/" : "//", m = ()=>{
                    O || (h = r(175), O = r(507));
                }, E = function(e, t) {
                    return m(), e = O.normalize(e), h.readFileSync(e, t ? void 0 : "utf8");
                }, f = (e)=>{
                    var t = E(e, !0);
                    return t.buffer || (t = new Uint8Array(t)), I(t.buffer), t;
                }, u = (e, t, r)=>{
                    m(), e = O.normalize(e), h.readFile(e, function(e, o) {
                        e ? r(e) : t(o.buffer);
                    });
            ...
            Oe(ue = "dilithium.wasm") || (fe = ue, ue = i.locateFile ? i.locateFile(fe, g) : g + fe);
            var _e = [];
            function De(e) {
                var t = _e[e];
            ...
            var xe, Ce = {
                ...
                function a(t) {
                    return (function() {
                        if (!w && (d || c)) {
                            if ("function" == typeof fetch && !me(ue)) return fetch(ue, {
                        ...
                        y("failed to asynchronously prepare wasm: " + e), me(ue) && y("warning: Loading from a file URI (" + ue + ") is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing"), Ee(e);
                    });
                }
                ...
                (w || "function" != typeof WebAssembly.instantiateStreaming || Oe(ue) || me(ue) || "function" != typeof fetch ? a(o) : fetch(ue, {
                    credentials: "same-origin"
                }).then(function(t) {
            ...
            }, Ye = i.stackSave = ge("stackSave"), ze = i.stackRestore = ge("stackRestore"), We = i.stackAlloc = ge("stackAlloc");
            function Ke(e) {
        ...
        e.exports = {
            ...
            sign: function(e, r, o, n) {
                ...
                const f = e.ccall("dilithium_sign", "number", [
                    ...
                    c,
                    n
                ]), h = e.getValue(u, "i32"), O = new Uint8Array(e.HEAPU8.buffer, E, h), m = new Uint8Array(O);
...
const s = ()=>(async function() {
        console.log("fetching wasm from /dilithium.wasm");
        const e = await fetch("/dilithium.wasm");
        return await e.arrayBuffer();
    })().then((e)=>i()({
            wasmBinary: e,
            locateFile: (e)=>e.endsWith(".wasm") ? "/node_modules/dilithium-crystals-js/dilithium.wasm" : e
        })).then((e)=>({
